...
b;return this};e.prototype.otherwise=function(a){this.when(null,a);return this};d.route=new e;d.addEventListener("popstate",g);l(g);d.addEventListener("routechange",function(){var a=d.router,b=f.querySelector("[data-view]");b&&(b.innerHTML=a.template,a=new CustomEvent("viewcontentloaded"),b.dispatchEvent(a))});var q=/^\s*(javascript|mailto):/i;l(function(){f.body.addEventListener("click",p)})})(window,document,location,history);
