...
f=n+k:n===c+"/"&&(f=n);b=!!f}b&&(a.preventDefault(),a="/"===d[0]?d:"/"+d,location.pathname!==g()+a&&(window.route.pathname=a))}}}l.prototype.when=function(a,b){var c=t(a);b.originalPath=c.originalPath;b.regexp=c.regexp;b.keys=c.keys;this.routes[a]=b;return this};l.prototype.otherwise=function(a){"string"===typeof a&&(a={redirectTo:a});this.when(null,a);return this};window.route=new l;window.addEventListener("popstate",m);q(m);window.addEventListener("routechange",function(){var a=window.route,b=document.querySelector("[data-view]");
b&&(b.innerHTML=a.template,a=new CustomEvent("viewcontentloaded"),b.dispatchEvent(a))});var x=/^\s*(javascript|mailto):/i,h=function(a){return a.substring(0,a.indexOf("/",a.indexOf("//")+2))}(location.href)+(g()||"/"),n=h.substr(0,stripHash(h).lastIndexOf("/")+1);q(function(){document.body.addEventListener("click",w)})})();
