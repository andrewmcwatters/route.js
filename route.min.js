...
window.route,b=a.routes,c,d,f;for(f in b)if(object.hasOwnProperty(f)){var g=b[f],e;if(e=!d){c=g.keys;e={};if(g.regexp){var h=g.regexp.exec(a.pathname);if(h){for(var m=1,k=h.length;m<k;++m){var l=c[m-1],n=h[m];l&&n&&(e[l.name]=n)}c=e}else c=null}else c=null;e=c}e&&(d=g,a.params=c)}return d||b[null]}function h(){var a=r();a&&(a.redirectTo?f.pathname=a.redirectTo:a.template?(f.template=a.template,k(a)):a.templateUrl?q(a,function(b){f.template=b;k(a)}):k(a))}function l(a){"loading"!=document.readyState?
...
this.routes[a]=b;return this};f.prototype.otherwise=function(a){"string"===typeof a&&(a={redirectTo:a});this.when(null,a);return this};window.route=new f;window.addEventListener("popstate",h);l(h);window.addEventListener("routechange",function(){var a=window.route,b=document.querySelector("[data-view]");b&&(b.innerHTML=a.template,a=new CustomEvent("viewcontentloaded"),b.dispatchEvent(a))});var u=/^\s*(javascript|mailto):/i;l(function(){document.body.addEventListener("click",t)})})();
